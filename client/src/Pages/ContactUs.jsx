          ...
          <VStack spacing={5} w="100%">
            ...
            <Stack w="100%" spacing={3} direction={{ base: 'column', md: 'row' }}>
              <FormControl className='parent' id="name">
                ...
                <Input type="text" placeholder="Aman Nambisan" rounded="md" onChange={setFormData} />
              </FormControl>

              <FormControl isInvalid={errors.email} className='parent' id="email" isRequired>
...
" rounded="md" onChange={setFormData} />
            ...
            <FormControl className='parent' id="message">
              ...
              <Textarea onChange={setFormData} size="lg" placeholder="Enter your message" rounded="md" />
            </FormControl>
